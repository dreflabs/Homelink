            ...
            <div className="mb-8 bg-slate-50 rounded-2xl p-6 border border-slate-100">
               ...
               <ul className="space-y-3">
                  <li className="flex items-center text-slate-700">
                    <BadgeCheck className="w-5 h-5  mr-3" /> Sertifikat Hak Milik (SHM)
                  </li>
                  <li className="flex items-center text-slate-700">
                    <BadgeCheck className="w-5 h-5  mr-3" /> Izin Mendirikan Bangunan (IMB) lengkap
                  </li>
                  <li className="flex items-center text-slate-700">
                    <BadgeCheck className="w-5 h-5  mr-3" /> Pajak Bumi dan Bangunan (PBB) lunas
                  </li>
               </ul>
            </div>
