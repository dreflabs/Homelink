...
import { Search, Filter, CircleDollarSign, ArrowUpRight, ArrowDownRight, ChartCandlestick } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card>
          <CardContent className="p-6">
            <div className="flex justify-between items-start">
              <div>
                <p className="text-sm font-medium text-gray-500">{t("total_commissions_ytd")}</p>
            ...
            <div className="mt-4 flex items-center text-sm">
              ...
              <span className="text-gray-500 ml-2">{t("vs_last_year")}</span>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex justify-between items-start">
              <div>
                <p className="text-sm font-medium text-gray-500">{t("pending_payouts")}</p>
            ...
            <div className="mt-4 flex items-center text-sm">
              <span className="text-gray-500">{pendingCount} {t("pending_transactions")}</span>
            </div>
          </CardContent>
        </Card>
          ...
          <div className="rounded-md border">
            <table className="w-full text-sm text-left">
              <thead className="bg-gray-50 text-gray-500 border-b">
                <tr>
                  <th className="px-4 py-3 font-medium">{t("transaction_id")}</th>
