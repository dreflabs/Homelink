...
import { Calendar as CalendarIcon, ChevronLeft, ChevronRight, Clock, MapPin, UserRound } from 'lucide-react';
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex gap-4 p-3 border rounded-lg hover:border-blue-300 transition-colors">
                ...
                <div className="flex-1 border-l pl-4">
                  <h4 className="text-sm font-medium text-gray-900">{t("property_verification_event")}</h4>
              ...
              <div className="flex gap-4 p-3 border rounded-lg hover:border-blue-300 transition-colors">
                ...
                <div className="flex-1 border-l pl-4">
                  <h4 className="text-sm font-medium text-gray-900">{t("client_meeting")}</h4>
                  <div className="flex items-center gap-2 mt-1 text-xs text-gray-500">
              ...
              <div className="flex gap-4 p-3 border rounded-lg hover:border-blue-300 transition-colors">
                ...
                <div className="flex-1 border-l pl-4">
                  <h4 className="text-sm font-medium text-gray-900">{t("team_sync")}</h4>
                  <div className="flex items-center gap-2 mt-1 text-xs text-gray-500">
                    <UserRound className="w-3 h-3" />
