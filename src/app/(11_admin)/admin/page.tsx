...
import { ClipboardCheck, Users, Home, Activity, History } from "lucide-react";
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card className="rounded-2xl border-slate-200 shadow-sm">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            ...
            <ClipboardCheck className="h-5 w-5 text-blue-700" strokeWidth={1.5} />
          </CardHeader>
          <CardContent>
        ...
        <Card className="rounded-2xl border-slate-200 shadow-sm group">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            ...
            <Users className="h-5 w-5 text-slate-400 group-hover:text-blue-700 transition-colors" strokeWidth={1.5} />
          </CardHeader>
          <CardContent>
        ...
        <Card className="rounded-2xl border-slate-200 shadow-sm">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            ...
            <Home className="h-5 w-5 text-slate-400" strokeWidth={1.5} />
          </CardHeader>
          <CardContent>
      ...
      <div className="space-y-4 mt-8">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <History className="h-5 w-5 text-slate-500" aria-hidden="true" strokeWidth={1.5} />
