...
export default function AgentCalendarPage() {
  ...
  return (
    <div className="space-y-8">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Kalender Jadwal</h1>
        <p className="text-slate-500 mt-1 text-sm">
          Agenda dan jadwal kerja Anda minggu ini.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="rounded-2xl shadow-sm border-slate-100 p-5 lg:col-span-1">
          <div className="flex items-center justify-between mb-4">
            <h3 className="font-semibold text-slate-900">Juli 2026</h3>
