...
export default function BillingDashboardPage() {
  const stats = [
    { title: "Total Revenue", value: "Rp 125.500.000", icon: DollarSign, trend: "+15%", color: "text-green-500" },
    { title: "Invoices Sent", value: "342", icon: FileText, trend: "+5%", color: "text-blue-500" },
    { title: "Paid Invoices", value: "298", icon: CheckCircle, trend: "+8%", color: "text-emerald-500" },
