...
import { Calendar, Image as ImageIcon, CheckCircle, Clock, MapPin, ChevronRight } from "lucide-react";
                  ...
                  <TableRow key={schedule.id} className="hover:bg-slate-50/50">
                    ...
                    <TableCell>
                      ...
                      <div className="flex items-center text-sm text-muted-foreground mt-1">
                        <Clock className="w-3.5 h-3.5 mr-2 text-slate-400" strokeWidth={1.5} />
                        {schedule.time}
                      </div>
                    </TableCell>
                    <TableCell>
