# CONTACT PAGE SPECIFICATION (REDIRECT)
...
```text
app/(17_company)/contact/page.tsx  → redirect('/contact')
```
...
## 4. Canonical Source
Lihat spesifikasi penuh di `docs/pages/01_public_website/03_CONTACT.md` (sudah terisi penuh — Read file tersebut untuk memastikan slug redirect benar, misalnya `contact`).
