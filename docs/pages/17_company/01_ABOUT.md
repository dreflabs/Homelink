# ABOUT PAGE SPECIFICATION (REDIRECT)
...
```text
app/(17_company)/about/page.tsx  → redirect('/about-us')
```
...
## 4. Canonical Source
Lihat spesifikasi penuh di `docs/pages/01_public_website/02_ABOUT_US.md` (sudah terisi penuh — Read file tersebut untuk memastikan slug redirect benar, misalnya `about-us`).
