# PRIVACY POLICY PAGE SPECIFICATION (REDIRECT)
...
```text
app/(01_public_website)/privacy-policy/page.tsx  → redirect('/legal/privacy-policy')
```
...
## 4. Canonical Source
Lihat spesifikasi penuh di `docs/pages/18_legal/01_PRIVACY_POLICY.md`.
