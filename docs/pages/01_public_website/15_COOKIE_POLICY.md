# COOKIE POLICY PAGE SPECIFICATION (REDIRECT)
...
```text
app/(01_public_website)/cookie-policy/page.tsx  → redirect('/legal/cookie-policy')
```
...
## 4. Canonical Source
Lihat spesifikasi penuh di `docs/pages/18_legal/03_COOKIE_POLICY.md`.
